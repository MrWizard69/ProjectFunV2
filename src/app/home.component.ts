...
canvas1.height = canvas.height;
	...
	//----------------------this guys sets up the virtual joystick. Thank you virtualjoystick.js--------------------------------//
		let joystick = this.VirtualJoystick.createJoy({
		...
		let shootStick = this.VirtualJoystick.createJoy({
    ...
    //----------------------End of full screen------------------------------------------//
		...
		setTimeout(function() {
		 ...
		 joystick = this.VirtualJoystick.createJoy({
				container: document.getElementById('container'),
				mouseSupport: true,
				limitStickTravel: true,
				stationaryBase: true, // to make the joystick appear anywhere, set to false and comment out BaseX and BaseY
		 ...
		 shootStick = this.VirtualJoystick.createJoy({
				container: document.getElementById('shootStick'),
				mouseSupport: true,
				limitStickTravel: true,
				stationaryBase: true, // to make the joystick appear anywhere, set to false and comment out BaseX and BaseY
